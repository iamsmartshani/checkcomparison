...
//    |   |   |   |   |- plugin.min.js
//$base_url= PATH;
//$base_url ="http://".$_SERVER['HTTP_HOST']."/isn-india.org/";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$base_url ="https://".$_SERVER['HTTP_HOST']."/";

$upload_dir = 'UserFiles/Image/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../UserFiles/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../UserFiles/Image/'; // relative path from filemanager folder to thumbs folder (with final /)
//echo $upload_dir." <br>".$current_path ."<br>".$thumbs_base_path;
// OPTIONAL SECURITY
...
$access_keys = array('mailerforbusiness','mfbinfo');
