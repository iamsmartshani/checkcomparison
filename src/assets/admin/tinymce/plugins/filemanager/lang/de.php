...
define('lang_Upload_java_help',"Wenn das Java Applet nicht l&auml;dt, 1. versichern Sie sich der aktuellen Java-Installation, download hier: <a href='http://java.com/en/download/'>[download link]</a> 2. &uuml;berpr&uuml;fen Sie Ihre Firewall-Einstellungen.");
...
define('lang_Paste_Confirm','Sind Sie sicher, dass Sie es in diesen Ordner einf&uuml;gen möchten? Existierende Dateien/Ordner files/folders if encountered any.');
...
define('lang_Copy_Cut_Size_Limit','Die Dateien sind zu gross, um sie %s. Limit: %d MB pro Aktion'); // %s = cut or copy
define('lang_Copy_Cut_Count_Limit','Sie haben zu viele Dateien gew&auml;hlt. Limit: %d Dateien pro Aktion'); // %s = cut or copy
define('lang_Copy_Cut_Not_Allowed','Die Dateien k&ouml;nnen so nicht veabeitet werden.'); // %s(1) = cut or copy, %s(2) = files or folders
define('lang_Aviary_No_Save', 'Das Bild konnte nicht gespeichert werden.');
define('lang_Zip_No_Extract', 'Zip Datei konnte nicht entpackt werden. Es ist m&ouml;glicherweise besch&auml;digt.');
...
define('lang_Function_Disabled', 'Ausschneiden und Kopieren ist serverseitig deaktiviert.'); // %s = cut or copy
?>